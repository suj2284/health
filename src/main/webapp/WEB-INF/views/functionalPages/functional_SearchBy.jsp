    ...
    <div class="collapse navbar-collapse" id="navbarCollapse">
      <ul class="navbar-nav me-auto mb-2 mb-md-0">
        <li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link" href="functional.html">건강기능식품</a>
          </li>
          <li class="nav-item">
...
<main class="d-flex flex-nowrap" style="position:fixed; top: 25px;">
  ...
  <div class="d-flex flex-column flex-shrink-0 p-3 text-white bg-dark" style="width: 250px;">
    ...
    <ul class="nav nav-pills flex-column mb-auto">
      <li class="nav-item">
        <a href="functional.html" class="nav-link text-white">
          <!-- <svg class="bi pe-none me-2" width="16" height="16"><use xlink:href="#home"/></svg> -->
          건강기능식품 목록
        </a>
      </li>
      <li>
        <a href="functional_SearchBy.html" class="nav-link active" aria-current="page">
          
          기준별 검색
        </a>
      </li>
      <li>
        <a href="functional_CustomInfo.html" class="nav-link text-white">
          
          맞춤 정보
        </a>
      </li>
      <li>
        <a href="functional_Report.html" class="nav-link text-white">
