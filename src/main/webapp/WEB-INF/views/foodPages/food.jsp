...
<link href="bootstrap-5.0.2-examples/sidebars/sidebars.css" rel="stylesheet">
    ...
    <style>
      ...
      .hc2 { display: inline-block; left:0; right:0; margin-left:auto; margin-right:auto; }
...
<div class="hc text-center" style="position: absolute; left: 270px; ">
  ...
  <table class="table table-striped table-hover" >
    ...
    <tbody>
      <tr>
        <td>0</td>
        <td><a href="food_detail.html">꿩불고기</a></td>
        <td>368.8</td>
        <td>39.7</td>
        <td>33.5</td>
        <td>8.5</td>
  ...
  <div class="hc2 text-center" >
    <ul class="pagination">

      <li><a class="btn btn-primary me-1" href="#"><</a></li>
      <li><a class="btn btn-primary me-1" href="#">1</a></li>
      <li><a class="btn btn-primary me-1" href="#">2</a></li>
      <li><a class="btn btn-primary me-1" href="#">3</a></li>
      <li><a class="btn btn-primary me-1" href="#">4</a></li>
      <li><a class="btn btn-primary me-1" href="#">5</a></li>
      <li><a class="btn btn-primary me-1" href="#">></a></li>
  ...
  <div class="text-center card-header py-3">
    ...
    <a href="#" onclick="search();" class="btn btn-primary">검색</a>
  </div>
