...
<main class="d-flex flex-nowrap" style="position:fixed; top: 25px;">
  ...
  <div class="d-flex flex-column flex-shrink-0 p-3 text-white bg-dark" style="width: 250px;">
    ...
    <ul class="nav nav-pills flex-column mb-auto">
      <li class="nav-item">
        <a href="mypage.html" class="nav-link active" aria-current="page">
          <!-- <svg class="bi pe-none me-2" width="16" height="16"><use xlink:href="#home"/></svg> -->
          회원 정보
        </a>
      </li>
      <li>
        <a href="mypage_TakenFood.html" class="nav-link text-white">
         
          식품 섭취 기록
        </a>
      </li>
      <li>
        <a href="mypage_TakenFunctional.html" class="nav-link text-white">
         
          건강기능식품 섭취 기록
        </a>
      </li>
      <li>
        <a href="mypage_TakenDrug.html" class="nav-link text-white">
