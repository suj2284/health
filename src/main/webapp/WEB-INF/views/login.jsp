...
<main class="container text-center form-signin w-100 m-auto">
  <form class="hc col-lg-4">
    ...
    <div  style="float: right;">
       <a href="#" class="text-muted" style= "text-decoration-line:none;"><small>아이디 </small></a>
       <small class="text-muted">|</small>
       <a href="#" class="text-muted" style= "text-decoration-line:none;"><small>비밀번호 찾기</small></a>
